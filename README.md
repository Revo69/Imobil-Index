...
| Tab | What you get |
|---|---|
| 🏷️ **For Sale** | Price per m² by sector, room/area profiles, new-build versus resale comparison, and 90-day trends |
...
- **Buyer-relevant sale profiles** — rooms and area bands refine the For Sale view; `New build vs resale` compares the two stable market segments without exposing listings
...
`api_*` table, including sale profiles and new-build versus resale metrics.
