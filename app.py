...
# Формируем подписи "Город → Район"
min_label = f"{min_row['city']} → {min_row['sector']}" if pd.notna(min_row['sector']) else min_row['city']
max_label = f"{max_row['city']} → {max_row['sector']}" if pd.notna(max_row['sector']) else max_row['city']
