...
col3.metric("📉 Самый дешёвый", df_now.loc[df_now['avg_per_m2_eur'].idxmin(), 'sector'] or "—")
col4.metric("📈 Самый дорогой", df_now.loc[df_now['avg_per_m2_eur'].idxmax(), 'sector'] or "—")
